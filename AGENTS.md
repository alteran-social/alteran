...
- Always Plan, Review Plan, Code, Review Code, Open PR
- Review ALWAYS means using multiple adverserial subagents
- Never make things backwards compatible or leave dead and legacy code lying around
- Always ensure we conform to the atproto spec. Clone it locally if required, as well as reference implementations:
